 ...
 */
@Stateless
@Path("udesc.desafio.veiculo")
public class veiculoFacadeREST extends AbstractFacade<veiculo> {

    @PersistenceContext(unitName = "desafio")
    ...
    protected EntityManager getEntityManager() {
        ...
        @Path("{modelo}")
        @Produces(MediaType.TEXT_PLAIN)
        public List<veiculo> buscarVeiculoTipo(String modelo) {
        EntityManager em = getEntityManager();
        Query buscar = em.createNamedQuery("veiculo.modelo");
        buscar.setParameter("modelo", modelo);
